...
const ColorInfo = () => {
  ...
  return (
    <div className="color-info-page-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: 'auto' }}>
      <h2 style={{ textAlign: 'center', padding: '10px', marginBottom: '20px', marginTop: '0px', background: '#031501', color: '#ffffff' }}>
	  Color Info: Color Finder, Contrast Checker & Gradient
	  </h2>

      <div className="color-info-container" style={{ width: '83.8%', maxWidth: '100%', margin: 'auto', alignItems: 'center', border: '1px solid #ccc', borderRadius: '15px', height: '400px', marginBottom: '20px' }}>
