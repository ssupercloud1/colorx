...
const ColorInfo = () => {
  ...
  return (
    <div className="color-info-page-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: 'auto' }}>
      ...
      <div className="color-info-container" style={{ width: '90%', maxWidth: '100%', margin: 'auto', justifyContent: 'center', border: '1px solid #ccc', borderRadius: '15px', height: '550px', marginBottom: '20px' }}>
