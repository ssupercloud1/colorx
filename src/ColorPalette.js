...
const ColorPalette = () => {
  ...
  return (
    <div className="color-palette-container" style={{ textAlign: 'justified', padding: '20px', maxWidth: '100%', margin: 'auto' }}>
	  <h2 style={{ textAlign: 'center', color: '#004B49' }}>Color Shades, Tints & Tones</h2>
      <p>
